...
def login(username, password):
    url = "http://82.156.185.106:5702/api/login?t=%s" % gettimestamp()
...
def getitem(searchValue):
    url = "http://82.156.185.106:5702/api/envs?searchValue=%s&t=%s" % (searchValue, gettimestamp())
    r = s.get(url)
...
def update(text, qlid):
    url = "http://82.156.185.106:5702/api/envs?t=%s" % gettimestamp()
