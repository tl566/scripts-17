...
let cashinviteCode = "eU9Ya7q3N_kj8G6AmHQa0Q";
let cashinviteCode2 = "";
let cashinviteCode3 = "";
let cashinviteCode4 = "";
let cashinviteCode5 = "";
...
newShareCodes = [
	{ inviteCode: `${cashinviteCode}` },
	{ inviteCode: `${cashinviteCode2}` },
	{ inviteCode: `${cashinviteCode3}` },
	{ inviteCode: `${cashinviteCode4}` },
	{ inviteCode: `${cashinviteCode5}` },
	{ inviteCode: `${cashinviteCode6}` },
	{ inviteCode: `${cashinviteCode7}` },
	{ inviteCode: `${cashinviteCode8}` },
	{ inviteCode: `${cashinviteCode9}` },
	{ inviteCode: `${cashinviteCode10}` },
]; //这里修改你的邀请码
if ($.isNode()) {
